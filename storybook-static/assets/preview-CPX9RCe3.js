import { i as S } from './tiny-invariant-CopsF_GD.js';
const { useEffect: T } = __STORYBOOK_MODULE_PREVIEW_API__,
	{ global: u } = __STORYBOOK_MODULE_GLOBAL__;
...
function et(e, t, { type: o, position: l = 'center', text: i }, n, r = !1) {
	let { x: f, y: a } = J(l, t),
		{ offsetX: s, offsetY: m } = Q(o, l, t, c + 1, r);
	((f += s), (a += m));
	let { w: g, h: d } = C(e, i);
	if (n && x({ x: f, y: a, w: g, h: d }, n)) {
		let M = tt(l, { x: f, y: a, w: g }, n);
		((f = M.x), (a = M.y));
	}
	return X(e, o, { x: f, y: a, w: g, h: d }, i);
}
...
function it(e, t, { type: o, text: l }) {
	let { floatingAlignment: i, extremities: n } = t,
		...
		f = n[i.y],
		{ w: a, h: s } = C(e, l),
		{ offsetX: m, offsetY: g } = ot(i, { w: a, h: s });
	return ((r += m), (f += g), X(e, o, { x: r, y: f, w: a, h: s }, l));
}
function E(e, t, o, l) {
	let i = [];
	o.forEach((n, r) => {
...
function lt(e, t, o, l) {
	let i = o.reduce((n, r) => {
		var f;
		return (Object.prototype.hasOwnProperty.call(n, r.position) || (n[r.position] = []), (f = n[r.position]) == null || f.push(r), n);
	}, {});
	(i.top && E(e, t, i.top, l),
...
function ft(e) {
	...
	((o = o + u.window.scrollY), (l = l + u.window.scrollX), (n = n + u.window.scrollY), (i = i + u.window.scrollX));
	let y = { top: p(a), bottom: p(s), left: p(m), right: p(g) },
		q = { top: p(d), bottom: p(M), left: p(k), right: p(F) },
		z = { top: p(I), bottom: p(D), left: p($), right: p(N) },
...
function at(e, { padding: t, border: o, width: l, height: i, top: n, left: r, bottom: f, right: a }) {
	let s = l - o.left - o.right,
		m = i - t.top - t.bottom - o.top - o.bottom;
	((e.fillStyle = L.padding),
		e.fillRect(r + o.left, n + o.top, s, t.top),
		e.fillRect(a - t.right - o.right, n + t.top + o.top, t.right, m),
		e.fillRect(r + o.left, f - t.bottom - o.bottom, s, t.bottom),
		e.fillRect(r + o.left, n + t.top + o.top, t.left, m));
	let g = [
		...
		return (
			...
			T(() => {
				...
				return (
					t.viewMode === 'story' &&
						o &&
						(document.addEventListener('pointerover', l), G(), window.addEventListener('resize', i), R(v.x, v.y)),
					() => {
