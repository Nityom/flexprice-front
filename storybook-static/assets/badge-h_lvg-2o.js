...
import { c as n } from './index-1evVQkiP.js';
...
function i({ className: r, variant: e, ...o }) {
	return t.jsx('div', { className: a(s({ variant: e }), r), ...o });
}
i.__docgenInfo = { description: '', methods: [], displayName: 'Badge', composes: ['VariantProps'] };
export { i as B };
