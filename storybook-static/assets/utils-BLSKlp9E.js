...
const B = '-',
	...
	ce = (e, r) =>
		r
			? e.map(([t, o]) => {
					const l = o.map((n) =>
						typeof n == 'string' ? r + n : typeof n == 'object' ? Object.fromEntries(Object.entries(n).map(([a, s]) => [r + a, s])) : n,
					);
					return [t, l];
				})
			: e,
	...
	Te = () => {
		...
		return {
			...
			classGroups: {
				...
				'font-weight': [{ font: ['thin', 'extralight', 'light', 'normal', 'medium', 'semibold', 'bold', 'extrabold', 'black', _] }],
				'font-family': [{ font: [j] }],
