...
function X() {
	...
	function P(e, t, n) {
		var o,
			...
			s = null;
		if (t != null)
			for (o in (t.ref !== void 0 && (s = t.ref), t.key !== void 0 && (c = '' + t.key), t))
				O.call(t, o) && !g.hasOwnProperty(o) && (u[o] = t[o]);
		...
		if (s)
			return (
				...
				j(u)
					...
					: u != null &&
						(R(u) && (u = G(u, n + (!u.key || (s && s.key === u.key) ? '' : ('' + u.key).replace(I, '$&/') + '/') + e)), t.push(u)),
				1
			);
		if (((s = 0), (o = o === '' ? '.' : o + ':'), j(e)))
			...
			for (e = i.call(e), f = 0; !(c = e.next()).done; ) ((c = c.value), (i = o + E(c, f++)), (s += d(c, t, n, i, u)));
		else if (c === 'object')
			throw (
				(t = String(e)),
				Error(
	...
	return (
		...
		(r.cloneElement = function (e, t, n) {
			...
			if (t != null) {
				...
				for (i in t) O.call(t, i) && !g.hasOwnProperty(i) && (o[i] = t[i] === void 0 && f !== void 0 ? f[i] : t[i]);
			}
