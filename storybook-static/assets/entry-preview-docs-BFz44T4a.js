...
import { c as Di, n as Ai, y as Ci, g as Vr, z as Ei, o as yi, j as qr, l as ee, B as Fi, a as Dt, Y as Ur } from './index-DgH-xKnr.js';
import { r as Ge, R as ft } from './index-t5q4d8OJ.js';
...
var Si = Z({
			...
			(function t(r) {
				...
				function m(x) {
					var y = {},
						v,
						B;
					for (v in x) x.hasOwnProperty(v) && ((B = x[v]), typeof B == 'object' && B !== null ? (y[v] = m(B)) : (y[v] = B));
					return y;
				}
				function g(x, y) {
					var v, B, P, j;
					for (B = x.length, P = 0; B; ) ((v = B >>> 1), (j = P + v), y(x[j]) ? (B = v) : ((P = j + 1), (B -= v + 1)));
					return P;
				}
				((n = {
				...
				function _(x, y, v) {
					...
					if (!v.length) {
						if (y.length) {
							for (M = 0, j = y.length; M < j; M += 1) ((P = m(y[M])), (P.extendedRange = [0, x.range[0]]), B.push(P));
							x.leadingComments = B;
						}
						return x;
					}
							...
							enter: function (U) {
								for (var Q; V < B.length && ((Q = B[V]), !(Q.extendedRange[1] > U.range[0])); )
									Q.extendedRange[1] === U.range[0]
										? (U.leadingComments || (U.leadingComments = []), U.leadingComments.push(Q), B.splice(V, 1))
										: (V += 1);
							...
							leave: function (U) {
								for (var Q; V < B.length && ((Q = B[V]), !(U.range[1] < Q.extendedRange[0])); )
									U.range[1] === Q.extendedRange[0]
										? (U.trailingComments || (U.trailingComments = []), U.trailingComments.push(Q), B.splice(V, 1))
										: (V += 1);
								if (V === B.length) return s.Break;
								if (B[V].extendedRange[0] > U.range[1]) return s.Skip;
							},
		...
		'../../node_modules/esutils/lib/keyword.js'(e, t) {
			(function () {
				...
				function m(D) {
					...
					for (E = 1, w = D.length; E < w; ++E) if (((b = D.charCodeAt(E)), !r.isIdentifierPartES5(b))) return !1;
					return !0;
				}
				function g(D, E) {
			...
			((e.encode = function (r) {
				...
				(e.decode = function (r) {
					var n = 65,
						...
						F = 26,
						A = 52;
					return n <= r && r <= s ? r - n : o <= r && r <= u ? r - o + F : h <= r && r <= p ? r - h + A : r == m ? 62 : r == g ? 63 : -1;
				}));
		},
	}),
	xn = Z({
			...
			((e.encode = function (p) {
				...
				(e.decode = function (p, m, g) {
					...
					do {
						...
						if (((E = t.decode(p.charCodeAt(m++))), E === -1)) throw new Error('Invalid base64 digit: ' + p.charAt(m - 1));
		...
		'../../node_modules/escodegen/node_modules/source-map/lib/mapping-list.js'(e) {
			...
			((n.prototype.unsortedForEach = function (s, o) {
				...
				(n.prototype.add = function (s) {
					r(this._last, s) ? ((this._last = s), this._array.push(s)) : ((this._sorted = !1), this._array.push(s));
				}),
			...
			((o.prototype._version = 3),
				...
				(o.prototype.setSourceContent = function (u, h) {
					...
					(this._sourceRoot != null && (p = r.relative(this._sourceRoot, p)),
						h != null
							? (this._sourcesContents || (this._sourcesContents = Object.create(null)), (this._sourcesContents[r.toSetString(p)] = h))
				...
				(o.prototype.applySourceMap = function (u, h, p) {
					...
					(this._mappings.unsortedForEach(function (C) {
						...
						u.sources.forEach(function (C) {
							...
							D != null && (p != null && (C = r.join(p, C)), g != null && (C = r.relative(g, C)), this.setSourceContent(C, D));
						}, this));
				}),
				(o.prototype._validateMapping = function (u, h, p, m) {
					...
					if (!(u && 'line' in u && 'column' in u && u.line > 0 && u.column >= 0 && !h && !p && !m)) {
						if (
							...
							return;
						throw new Error('Invalid mapping: ' + JSON.stringify({ generated: u, source: p, original: h, name: m }));
					}
				}),
				(o.prototype._serializeMappings = function () {
					for (
						var u = 0, h = 1, p = 0, m = 0, g = 0, F = 0, A = '', C, D, E, w, b = this._mappings.toArray(), S = 0, L = b.length;
						S < L;
						S++
					) {
						if (((D = b[S]), (C = ''), D.generatedLine !== h)) for (u = 0; D.generatedLine !== h; ) ((C += ';'), h++);
						else if (S > 0) {
	...
	Mi = Z({
		'../../node_modules/escodegen/node_modules/source-map/lib/source-map-consumer.js'(e) {
			...
			function u(g, F) {
				var A = g;
				return (typeof g == 'string' && (A = t.parseSourceMapInput(g)), A.sections != null ? new m(A, F) : new h(A, F));
			}
			...
			((h.prototype = Object.create(u.prototype)),
				...
				(h.prototype._findSourceIndex = function (g) {
					var F = g;
					if ((this.sourceRoot != null && (F = t.relative(this.sourceRoot, F)), this._sources.has(F))) return this._sources.indexOf(F);
					var A;
				...
				(h.fromSourceMap = function (g, F) {
					...
					for (
						var E = g._mappings.toArray().slice(), w = (A.__generatedMappings = []), b = (A.__originalMappings = []), S = 0, L = E.length;
						S < L;
						S++
					) {
						var _ = E[S],
			...
			((h.prototype._parseMappings = function (g, F) {
				for (var A = 1, C = 0, D = 0, E = 0, w = 0, b = 0, S = g.length, L = 0, _ = {}, x = {}, y = [], v = [], B, P, j, M, V; L < S; )
					if (g.charAt(L) === ';') (A++, L++, (C = 0));
					else if (g.charAt(L) === ',') L++;
					else {
						for (B = new p(), B.generatedLine = A, M = L; M < S && !this._charIsMappingSeparator(g, M); M++);
					...
					if (A >= 0) {
						...
						if (C.generatedLine === F.generatedLine) {
							...
							return (
								...
								{ source: D, line: t.getArg(C, 'originalLine', null), column: t.getArg(C, 'originalColumn', null), name: E }
							);
						}
					}
			...
			function m(g, F) {
				...
				this._sections = D.map(function (w) {
					...
					var b = t.getArg(w, 'offset'),
						S = t.getArg(b, 'line'),
						L = t.getArg(b, 'column');
					if (S < E.line || (S === E.line && L < E.column)) throw new Error('Section offsets must be ordered and non-overlapping.');
					return ((E = b), { generatedOffset: { generatedLine: S + 1, generatedColumn: L + 1 }, consumer: new u(t.getArg(w, 'map'), F) });
				});
			}
				...
				Object.defineProperty(m.prototype, 'sources', {
					get: function () {
						for (var g = [], F = 0; F < this._sections.length; F++)
							for (var A = 0; A < this._sections[F].consumer.sources.length; A++) g.push(this._sections[F].consumer.sources[A]);
						return g;
					},
				}),
				(m.prototype.originalPositionFor = function (g) {
					...
					return C
						? C.consumer.originalPositionFor({
								...
								column:
									F.generatedColumn - (C.generatedOffset.generatedLine === F.generatedLine ? C.generatedOffset.generatedColumn - 1 : 0),
								bias: g.bias,
							})
						...
						if (A.consumer._findSourceIndex(t.getArg(g, 'source')) !== -1) {
							...
							if (C) {
								var D = {
									...
									column: C.column + (A.generatedOffset.generatedLine === C.line ? A.generatedOffset.generatedColumn - 1 : 0),
								};
								return D;
							}
						}
				...
				(m.prototype._parseMappings = function (g, F) {
					...
					for (var A = 0; A < this._sections.length; A++)
						for (var C = this._sections[A], D = C.consumer._generatedMappings, E = 0; E < D.length; E++) {
							...
							var S = null;
							w.name && ((S = C.consumer._names.at(w.name)), this._names.add(S), (S = this._names.indexOf(S)));
							var L = {
								source: b,
								generatedLine: w.generatedLine + (C.generatedOffset.generatedLine - 1),
								generatedColumn:
									w.generatedColumn + (C.generatedOffset.generatedLine === w.generatedLine ? C.generatedOffset.generatedColumn - 1 : 0),
		...
		'../../node_modules/escodegen/node_modules/source-map/lib/source-node.js'(e) {
			...
			((u.fromStringWithSourceMap = function (h, p, m) {
				...
				return (
					p.eachMapping(function (S) {
						...
						if (E < S.generatedColumn) {
							var L = F[A] || '';
							(g.add(L.substr(0, S.generatedColumn)), (F[A] = L.substr(S.generatedColumn)), (E = S.generatedColumn));
						}
						w = S;
					}, this),
				...
				(u.prototype.walkSourceContents = function (h) {
					for (var p = 0, m = this.children.length; p < m; p++) this.children[p][o] && this.children[p].walkSourceContents(h);
							...
							((p.code += E),
								w.source !== null && w.line !== null && w.column !== null
									? ((F !== w.source || A !== w.line || C !== w.column || D !== w.name) &&
										...
										(D = w.name),
										(g = !0))
									: g && (m.addMapping({ generated: { line: p.line, column: p.column } }), (F = null), (g = !1)));
	...
	qi = Z({
		'../../node_modules/escodegen/node_modules/source-map/source-map.js'(e) {
			((e.SourceMapGenerator = _n().SourceMapGenerator), (e.SourceMapConsumer = Mi().SourceMapConsumer), (e.SourceNode = Vi().SourceNode));
		},
	}),
	Ui = Z({
...
`,
				...
				function Ft(i, l) {
					...
					for (a in l) l.hasOwnProperty(a) && ((c = l[a]), d(c) ? (d(i[a]) ? Ft(i[a], c) : (i[a] = Ft({}, c))) : (i[a] = c));
					return i;
				}
				function si(i) {
					var l, a, c, d, k;
					...
					return (
						...
						d !== 0 && (c += 'e' + d),
						(c.length < l.length || (F && i > 1e12 && Math.floor(i) === i && (c = '0x' + i.toString(16)).length < l.length)) &&
							+c === i &&
							(l = c),
						l
					);
					...
					if (((a = i.toString()), i.source)) {
						...
						for (c = l[1], a = '', T = !1, O = !1, d = 0, k = i.source.length; d < k; ++d)
							((I = i.source.charCodeAt(d)),
								O
									? ((a += Tr(I, O)), (O = !1))
									: (T ? I === 93 && (T = !1) : I === 47 ? (a += '\\') : I === 91 && (T = !0), (a += Tr(I, O)), (O = I === 92)));
						return '/' + a + '/' + c;
					}
					return a;
				}
				...
				function ci(i) {
					...
					for (a = 0, c = i.length; a < c; ++a) {
						if (((d = i.charCodeAt(a)), d === 39)) ++k;
							...
							l += oi(d);
							continue;
						} else if (!u.code.isIdentifierPartES5(d) && ((m && d < 32) || (!m && !C && (d < 32 || d > 126)))) {
							l += ai(d, i.charCodeAt(a + 1));
							continue;
						}
						l += String.fromCharCode(d);
					}
					if (((T = !(A === 'double' || (A === 'auto' && I < k))), (O = T ? "'" : '"'), !(T ? k : I))) return O + l + O;
					for (i = l, l = O, a = 0, c = i.length; a < c; ++a)
						((d = i.charCodeAt(a)), ((d === 39 && T) || (d === 34 && !T)) && (l += '\\'), (l += String.fromCharCode(d)));
					return l + O;
				}
				function Pr(i) {
					var l,
				...
				function K(i, l) {
					...
					return l.loc == null
						...
						: new s(l.loc.start.line, l.loc.start.column, y === !0 ? l.loc.source || null : y, i, l.name || null);
				}
				function pe() {
					return E || ' ';
				}
							...
							: ((c = K(l).toString()),
								c.length === 0
									...
									: ((d = a.charCodeAt(a.length - 1)),
										...
										(d === 47 && k === 105)
											? [i, pe(), l]
											: u.code.isWhiteSpace(d) || u.code.isLineTerminator(d) || u.code.isWhiteSpace(k) || u.code.isLineTerminator(k)
												? [i, l]
												: [i, E, l]))
					);
				}
...
`,
							...
							for (I = !he(K(l).toString()), T = Me(' ', hi(K([h, l, p]).toString())), a = 0, c = i.trailingComments.length; a < c; ++a)
...
` && d++;
				...
				function fi(i, l) {
					...
					return (
						...
						typeof a == 'string'
							...
							: ((c = Lr(a.content)), (d = a.precedence != null ? a.precedence : r.Sequence), (c = le(c, d, l))),
						K(c, i)
					);
				}
				function oe() {}
				((oe.prototype.maybeBlock = function (i, l) {
					...
					(oe.prototype.maybeBlockSuffix = function (i, l) {
						...
						return i.type === t.BlockStatement && (!_.comment || !i.leadingComments) && !a ? [l, E] : a ? [l, h] : [l, D, h];
					}));
				function Ae(i) {
					return K(i.name, i);
				}
				...
				((oe.prototype.generatePattern = function (i, l, a) {
						...
						if (
							...
							for (
								...
								(d && i.defaults[l]
									...
									l + 1 < a && c.push(',' + E));
							(i.rest && (i.params.length && c.push(',' + E), c.push('...'), c.push(Ae(i.rest))), c.push(')'));
						}
						return c;
					}),
						...
						return (
							ae(function () {
								(l.left.type === t.VariableDeclaration
									? ae(function () {
											(c.push(l.left.kind + pe()), c.push(d.generateStatement(l.left.declarations[0], yt)));
										})
					...
					(oe.prototype.generatePropertyKey = function (i, l) {
						var a = [];
						return (l && a.push('['), a.push(this.generateExpression(i, r.Assignment, R)), l && a.push(']'), a);
					}),
					(oe.prototype.generateAssignment = function (i, l, a, c, d) {
						return (
							r.Assignment < c && (d |= U),
							le([this.generateExpression(i, r.Call, d), E + a + E, this.generateExpression(l, r.Assignment, d)], r.Assignment, c)
						);
					}),
...
` && (d = ['{'])),
											...
											d.push(O),
											he(K(O).toString()) || (B && I < T - 1 && i.body[I + 1].leadingComments) || d.push(D),
											B && I === T - 1 && (i.body[I].trailingComments || He(i.body[I].range[1], i.range[1], d)));
								}),
								d.push(fe('}')),
								d
							);
						...
						ContinueStatement: function (i, l) {
							return i.label ? 'continue ' + i.label.name + this.semicolon(l) : 'continue' + this.semicolon(l);
						},
							...
							return (
								ae(function (d) {
									...
									for (k = 0, I = i.body.length; k < I; ++k)
										(a.push(d), a.push(c.generateExpression(i.body[k], r.Sequence, R)), k + 1 < I && a.push(D));
								}),
						...
						ClassDeclaration: function (i, l) {
							...
							return (
								...
								i.superClass && ((c = W('extends', this.generateExpression(i.superClass, r.Unary, R))), (a = W(a, c))),
								a.push(E),
						...
						DoWhileStatement: function (i, l) {
							...
							return (
								...
								W(a, ['while' + E + '(', this.generateExpression(i.test, r.Sequence, R), ')' + this.semicolon(l)])
							);
						},
								...
								ae(function () {
									...
									i.param
										? ((a = ['catch' + E + '(', c.generateExpression(i.param, r.Sequence, R), ')']),
											i.guard && ((d = c.generateExpression(i.guard, r.Sequence, R)), a.splice(2, 0, ' if ', d)))
										: (a = ['catch']);
								}),
						...
						ExportDefaultDeclaration: function (i, l) {
							...
							return (
								...
								V(i.declaration)
									...
									: (a = W(a, this.generateExpression(i.declaration, r.Assignment, R) + this.semicolon(l))),
								a
							);
						},
													...
													: ((a = W(a, '{')),
														ae(function (k) {
															...
															for (a.push(D), I = 0, T = i.specifiers.length; I < T; ++I)
																(a.push(k), a.push(d.generateExpression(i.specifiers[I], r.Sequence, R)), I + 1 < T && a.push(',' + D));
														}),
														he(K(a).toString()) || a.push(D),
														a.push(h + '}')),
											i.source
												? (a = W(a, ['from' + E, this.generateExpression(i.source, r.Sequence, R), this.semicolon(l)]))
												: a.push(this.semicolon(l))),
										a)
							);
						},
						ExportAllDeclaration: function (i, l) {
							return ['export' + E, '*' + E, 'from' + E, this.generateExpression(i.source, r.Sequence, R), this.semicolon(l)];
						},
						ExpressionStatement: function (i, l) {
							...
							function d(T) {
								...
								return T.slice(0, 5) !== 'class'
									? !1
									: ((O = T.charCodeAt(5)), O === 123 || u.code.isWhiteSpace(O) || u.code.isLineTerminator(O));
							}
							function k(T) {
								var O;
								return T.slice(0, 8) !== 'function'
									? !1
									: ((O = T.charCodeAt(8)), O === 40 || u.code.isWhiteSpace(O) || O === 42 || u.code.isLineTerminator(O));
							}
							function I(T) {
								var O, X, ce;
								...
								return X === ce || T.slice(X, X + 8) !== 'function'
									? !1
									: ((O = T.charCodeAt(X + 8)), O === 40 || u.code.isWhiteSpace(O) || O === 42 || u.code.isLineTerminator(O));
							}
							return (
								...
								k(c) ||
								I(c) ||
								(L && l & ue && i.expression.type === t.Literal && typeof i.expression.value == 'string')
										...
										i.specifiers[c].type === t.ImportNamespaceSpecifier
											...
											: (a.push(E + '{'),
												i.specifiers.length - c === 1
													? (a.push(E), a.push(this.generateExpression(i.specifiers[c], r.Sequence, R)), a.push(E + '}' + E))
													: (ae(function (k) {
															var I, T;
						...
						VariableDeclarator: function (i, l) {
							var a = l & U ? R : st;
							return i.init
								? [this.generateExpression(i.id, r.Assignment, a), E, '=', E, this.generateExpression(i.init, r.Assignment, a)]
...
`),
						...
						TryStatement: function (i, l) {
							var a, c, d, k;
							if (((a = ['try', this.maybeBlock(i.block, re)]), (a = this.maybeBlockSuffix(i.block, a)), i.handlers))
								for (c = 0, d = i.handlers.length; c < d; ++c)
									((a = W(a, this.generateStatement(i.handlers[c], re))),
										(i.finalizer || c + 1 !== d) && (a = this.maybeBlockSuffix(i.handlers[c].body, a)));
							else {
								for (k = i.guardedHandlers || [], c = 0, d = k.length; c < d; ++c)
									((a = W(a, this.generateStatement(k[c], re))), (i.finalizer || c + 1 !== d) && (a = this.maybeBlockSuffix(k[c].body, a)));
								if (i.handler)
									if (Array.isArray(i.handler))
										for (c = 0, d = i.handler.length; c < d; ++c)
											((a = W(a, this.generateStatement(i.handler[c], re))),
												(i.finalizer || c + 1 !== d) && (a = this.maybeBlockSuffix(i.handler[c].body, a)));
									else ((a = W(a, this.generateStatement(i.handler, re))), i.finalizer && (a = this.maybeBlockSuffix(i.handler.body, a)));
							}
						...
						SwitchStatement: function (i, l) {
							...
							if (
								(ae(function () {
									a = ['switch' + E + '(', T.generateExpression(i.discriminant, r.Sequence, R), ')' + E + '{' + D];
								}),
								i.cases)
							)
								for (I = re, d = 0, k = i.cases.length; d < k; ++d)
									(d === k - 1 && (I |= $), (c = fe(this.generateStatement(i.cases[d], I))), a.push(c), he(K(c).toString()) || a.push(D));
							return (a.push(fe('}')), a);
						},
						SwitchCase: function (i, l) {
							...
							return (
								ae(function () {
									for (
										i.test ? (a = [W('case', T.generateExpression(i.test, r.Sequence, R)), ':']) : (a = ['default:']),
											d = 0,
											k = i.consequent.length,
											k && i.consequent[0].type === t.BlockStatement && ((c = T.maybeBlock(i.consequent[0], re)), a.push(c), (d = 1)),
...
`
								...
								(!S && d === k - 1 && (I |= $),
									B &&
										(d === 0 && (i.body[0].leadingComments || He(i.range[0], i.body[d].range[0], a)),
										d > 0 &&
									...
									a.push(c),
									d + 1 < k && !he(K(c).toString()) && ((B && i.body[d + 1].leadingComments) || a.push(D)),
									B && d === k - 1 && (i.body[d].trailingComments || He(i.body[d].range[1], i.range[1], a)));
							return a;
						},
						FunctionDeclaration: function (i, l) {
							return [at(i, !0), 'function', xt(i) || pe(), i.id ? Ae(i.id) : '', this.generateFunctionBody(i)];
						},
					...
					(oe.Expression = {
						SequenceExpression: function (i, l, a) {
							...
							for (r.Sequence < l && (a |= U), c = [], d = 0, k = i.expressions.length; d < k; ++d)
								(c.push(this.generateExpression(i.expressions[d], r.Assignment, a)), d + 1 < k && c.push(',' + E));
						...
						BinaryExpression: function (i, l, a) {
							...
							return (
								...
								(O = T.toString()),
								O.charCodeAt(O.length - 1) === 47 && u.code.isIdentifierPartES5(i.operator.charCodeAt(0))
									? (c = [T, pe(), i.operator])
									: (c = W(T, i.operator)),
						...
						CallExpression: function (i, l, a) {
							var c, d, k;
							for (
								c = [this.generateExpression(i.callee, r.Call, Re)], i.optional && c.push('?.'), c.push('('), d = 0, k = i.arguments.length;
								d < k;
								++d
							)
								(c.push(this.generateExpression(i.arguments[d], r.Assignment, R)), d + 1 < k && c.push(',' + E));
						...
						NewExpression: function (i, l, a) {
							...
							if (
								...
								for (c.push('('), k = 0, I = d; k < I; ++k)
									(c.push(this.generateExpression(i.arguments[k], r.Assignment, R)), k + 1 < I && c.push(',' + E));
								c.push(')');
							}
							return le(c, r.New, l);
						},
									...
									: ((c = [i.operator]),
										i.operator.length > 2
											...
											: ((I = K(c).toString()),
												...
												(((T === 43 || T === 45) && T === k) || (u.code.isIdentifierPartES5(T) && u.code.isIdentifierPartES5(k))) &&
													c.push(pe()),
												c.push(d))),
								le(c, r.Unary, l)
							);
						...
						FunctionExpression: function (i, l, a) {
							...
							return (i.id ? (c.push(xt(i) || pe()), c.push(Ae(i.id))) : c.push(xt(i) || E), c.push(this.generateFunctionBody(i)), c);
						},
								...
								? ((k = c ? !1 : i.elements.length > 1),
									...
									ae(function (T) {
										...
										for (O = 0, X = i.elements.length; O < X; ++O)
											(i.elements[O]
												? (d.push(k ? T : ''), d.push(I.generateExpression(i.elements[O], r.Assignment, R)))
						...
						ClassExpression: function (i, l, a) {
							...
							return (
								...
								i.superClass && ((d = W('extends', this.generateExpression(i.superClass, r.Unary, R))), (c = W(c, d))),
								c.push(E),
						...
						MethodDefinition: function (i, l, a) {
							...
							return (
								...
								i.kind === 'get' || i.kind === 'set'
									? (d = [W(i.kind, this.generatePropertyKey(i.key, i.computed)), this.generateFunctionBody(i.value)])
									: (d = [Or(i), this.generatePropertyKey(i.key, i.computed), this.generateFunctionBody(i.value)]),
								W(c, d)
							);
						},
						Property: function (i, l, a) {
							return i.kind === 'get' || i.kind === 'set'
								? [i.kind, pe(), this.generatePropertyKey(i.key, i.computed), this.generateFunctionBody(i.value)]
								: i.shorthand
									? i.value.type === 'AssignmentPattern'
										? this.AssignmentPattern(i.value, r.Sequence, R)
										: this.generatePropertyKey(i.key, i.computed)
									: i.method
										? [Or(i), this.generatePropertyKey(i.key, i.computed), this.generateFunctionBody(i.value)]
										: [this.generatePropertyKey(i.key, i.computed), ':' + E, this.generateExpression(i.value, r.Assignment, R)];
						},
										...
										: (ae(function (T) {
												...
												if (((d = ['{', D, T, k]), c))
													for (d.push(',' + D), O = 1, X = i.properties.length; O < X; ++O)
														(d.push(T), d.push(I.generateExpression(i.properties[O], r.Sequence, R)), O + 1 < X && d.push(',' + D));
											}),
						...
						ObjectPattern: function (i, l, a) {
							...
							if (((I = !1), i.properties.length === 1))
								((T = i.properties[0]), T.type === t.Property && T.value.type !== t.Identifier && (I = !0));
							else
						...
						Literal: function (i, l, a) {
							...
							if (i.hasOwnProperty('raw') && x && _.raw)
								try {
									if (((c = x(i.raw).body[0].expression), c.type === t.Literal && c.value === i.value)) return i.raw;
								} catch {}
							return i.regex
						...
						ComprehensionExpression: function (i, l, a) {
							...
							return (
								...
								_.moz.comprehensionExpressionStartsWithAssignment && ((I = this.generateExpression(i.body, r.Assignment, R)), c.push(I)),
								i.blocks &&
									ae(function () {
										for (d = 0, k = i.blocks.length; d < k; ++d)
											((I = T.generateExpression(i.blocks[d], r.Sequence, R)),
												d > 0 || _.moz.comprehensionExpressionStartsWithAssignment ? (c = W(c, I)) : c.push(I));
									}),
								i.filter && ((c = W(c, 'if' + E)), (I = this.generateExpression(i.filter, r.Sequence, R)), (c = W(c, ['(', I, ')']))),
						...
						TaggedTemplateExpression: function (i, l, a) {
							var c = Re;
							a & Q || (c = Xe);
							var d = [this.generateExpression(i.tag, r.Call, c), this.generateExpression(i.quasi, r.Primary, je)];
						...
						TemplateLiteral: function (i, l, a) {
							...
							for (c = ['`'], d = 0, k = i.quasis.length; d < k; ++d)
								(c.push(this.generateExpression(i.quasis[d], r.Primary, R)),
									d + 1 < k && (c.push('${' + E), c.push(this.generateExpression(i.expressions[d], r.Sequence, R)), c.push(E + '}')));
							return (c.push('`'), c);
						},
					...
					(oe.prototype.generateExpression = function (i, l, a) {
						...
						return (
							(d = i.type || t.Property),
							_.verbatim && i.hasOwnProperty(_.verbatim) ? fi(i, l) : ((c = this[d](i, l, a)), _.comment && (c = Nr(i, c)), K(c, i))
						);
					}),
...
function zi(e) {
	...
	if ((t.ecmaVersion >= 2015 && (t.ecmaVersion -= 2009), t.allowReserved == null && (t.allowReserved = t.ecmaVersion < 5), cr(t.onToken))) {
		var n = t.onToken;
	...
	gr = gi({
		'../../node_modules/acorn/dist/acorn.mjs'() {
			((bt = {
				...
				(Qr = { 5: Bt, '5module': Bt + ' export import', 6: Bt + ' const class extends export import super' }),
				(Yr = /^in(stanceof)?$/),
				(wt =
				...
				(te = function (e, t, r) {
					((this.options = e = zi(e)),
						...
						(this.keywords = We(Qr[e.ecmaVersion >= 6 ? 6 : e.sourceType === 'module' ? '5module' : 5])));
					var n = '';
...
`,
					...
					for (;;) {
						...
						if ((t[1] || t[2]) === 'use strict') {
							...
							return (
								s === ';' ||
								s === '}' ||
								(De.test(r[0]) && !(/[(`.[+\-/*%<>=,?^&]/.test(s) || (s === '!' && this.input.charAt(n + 1) === '=')))
							);
						}
				...
				(de.canInsertSemicolon = function () {
					return this.type === f.eof || this.type === f.braceR || De.test(this.input.slice(this.lastTokEnd, this.start));
				}),
				...
				(z.parseStatement = function (e, t, r) {
					...
					switch ((this.isLet(e) && ((n = f._var), (o = 'let')), n)) {
						...
						case f._const:
						case f._var:
							return ((o = o || this.value), e && o !== 'var' && this.unexpected(), this.parseVarStatement(s, o));
						case f._while:
				...
				(z.parseForStatement = function (e) {
					...
					if (this.type === f._var || this.type === f._const || r) {
						...
						return (
							...
							(this.type === f._in || (this.options.ecmaVersion >= 6 && this.isContextual('of'))) && n.declarations.length === 1
				...
				(z.parseThrowStatement = function (e) {
					return (
						this.next(),
						De.test(this.input.slice(this.lastTokEnd, this.start)) && this.raise(this.lastTokEnd, 'Illegal newline after throw'),
				...
				(z.parseTryStatement = function (e) {
					if ((this.next(), (e.block = this.parseBlock()), (e.handler = null), this.type === f._catch)) {
						...
						if ((this.next(), this.eat(f.parenL))) {
							...
							(this.enterScope(r ? Jt : 0), this.checkLVal(t.param, r ? Kt : _e), this.expect(f.parenR));
					...
					for (e.declarations = [], e.kind = r; ; ) {
						...
						if (
							...
							this.eat(f.eq)
								...
								: r === 'const' && !(this.type === f._in || (this.options.ecmaVersion >= 6 && this.isContextual('of')))
									? this.unexpected()
									: n.id.type !== 'Identifier' && !(t && (this.type === f._in || this.isContextual('of')))
				...
				(z.parseFunction = function (e, t, r, n) {
					(this.initFunction(e),
						...
						t & Ke &&
							...
							e.id &&
								!(t & Pt) &&
								this.checkLVal(e.id, this.strict || e.generator || e.async ? (this.treatFunctionsAsVar ? It : _e) : Yt)));
					var s = this.yieldPos,
						o = this.awaitPos,
				...
				(z.parseExport = function (e, t) {
					...
					if (this.eat(f._default)) {
						...
						if (this.type === f._function || (r = this.isAsyncFunction())) {
							var n = this.startNode();
							(this.next(), r && this.next(), (e.declaration = this.parseFunction(n, Ke | $t, !1, r)));
				...
				(Se.checkLVal = function (e, t, r) {
					switch ((t === void 0 && (t = Qt), e.type)) {
						case 'Identifier':
							(t === _e && e.name === 'let' && this.raiseRecoverable(e.start, 'let is disallowed as a lexically bound name'),
								this.strict &&
									this.reservedWordsStrictBind.test(e.name) &&
									this.raiseRecoverable(e.start, (t ? 'Binding ' : 'Assigning to ') + e.name + ' in strict mode'),
								r && (Nt(r, e.name) && this.raiseRecoverable(e.start, 'Argument name clash'), (r[e.name] = !0)),
				...
				(G.parseMaybeAssign = function (e, t, r) {
					...
					var n = !1,
						...
						o = -1;
					t
						? ((s = t.parenthesizedAssign), (o = t.trailingComma), (t.parenthesizedAssign = t.trailingComma = -1))
						: ((t = new _t()), (n = !0));
					var u = this.start,
						h = this.startLoc;
				...
				(G.parseExprOp = function (e, t, r, n, s) {
					...
					if (o != null && (!s || this.type !== f._in) && o > n) {
						...
						return (
							((u && this.type === f.coalesce) || (h && (this.type === f.logicalOR || this.type === f.logicalAND))) &&
				...
				(G.buildBinary = function (e, t, r, n, s, o) {
					...
					return ((u.left = r), (u.operator = s), (u.right = n), this.finishNode(u, o ? 'LogicalExpression' : 'BinaryExpression'));
				}),
				(G.parseMaybeUnary = function (e, t) {
					...
					return !t && this.eat(f.starstar) ? this.buildBinary(r, n, s, this.parseMaybeUnary(null, !1), '**', !1) : s;
				}),
				...
				(G.parseSubscript = function (e, t, r, n, s, o) {
					...
					if (p || (h && this.type !== f.parenL && this.type !== f.backQuote) || this.eat(f.dot)) {
						...
						((m.object = e),
							(m.property = p ? this.parseExpression() : this.parseIdent(this.options.allowReserved !== 'never')),
							(m.computed = !!p),
						...
						((E.callee = e), (E.arguments = D), u && (E.optional = h), (e = this.finishNode(E, 'CallExpression')));
					...
					switch (this.type) {
						...
						case f.name:
							var n = this.start,
								...
								o = this.containsEsc,
								u = this.parseIdent(!1);
							if (this.options.ecmaVersion >= 8 && !o && u.name === 'async' && !this.canInsertSemicolon() && this.eat(f._function))
						...
						case f.parenL:
							...
							return (
								e &&
									(e.parenthesizedAssign < 0 && !this.isSimpleAssignTarget(m) && (e.parenthesizedAssign = p),
				...
				(G.parseParenAndDistinguishExpression = function (e) {
					...
					if (this.options.ecmaVersion >= 6) {
						...
						((!h.length || m) && this.unexpected(this.lastTokStart),
							...
							(this.awaitPos = A || this.awaitPos),
							h.length > 1
								? ((n = this.startNodeAt(o, u)), (n.expressions = h), this.finishNodeAt(n, 'SequenceExpression', D, E))
								: (n = h[0]));
				...
				(G.parseNew = function () {
					...
					return (
						...
						this.eat(f.parenL) ? (e.arguments = this.parseExprList(f.parenR, this.options.ecmaVersion >= 8, !1)) : (e.arguments = tn),
...
`,
				...
				(G.parseProperty = function (e, t) {
					...
					this.options.ecmaVersion >= 6 &&
						((r.method = !1), (r.shorthand = !1), (e || t) && ((o = this.start), (u = this.startLoc)), e || (n = this.eat(f.star)));
					var h = this.containsEsc;
					return (
						this.parsePropertyName(r),
						!e && !h && this.options.ecmaVersion >= 8 && !n && this.isAsyncProp(r)
							? ((s = !0), (n = this.options.ecmaVersion >= 9 && this.eat(f.star)), this.parsePropertyName(r, t))
							: (s = !1),
						...
						this.options.ecmaVersion >= 6 && !e.computed && e.key.type === 'Identifier'
							? ((r || n) && this.unexpected(),
								...
								t
									...
									: this.type === f.eq && u
										? (u.shorthandAssign < 0 && (u.shorthandAssign = this.start), (e.value = this.parseMaybeDefault(s, o, e.key)))
										: (e.value = e.key),
								(e.shorthand = !0))
							: this.unexpected();
				}),
				...
				(G.parseFunctionBody = function (e, t, r) {
					...
					if (n) ((e.body = this.parseMaybeAssign()), (e.expression = !0), this.checkParams(e, !1));
						...
						(!s || u) &&
							...
							o && u && this.raiseRecoverable(e.start, "Illegal 'use strict' directive in function with non-simple parameter list"));
						var h = this.labels;
						((this.labels = []),
							o && (this.strict = !0),
					...
					for (var s = [], o = !0; !this.eat(e); ) {
						...
						(r && this.type === f.comma
							...
							: this.type === f.ellipsis
								? ((u = this.parseSpread(n)), n && this.type === f.comma && n.trailingComma < 0 && (n.trailingComma = this.start))
				...
				(G.checkUnreserved = function (e) {
					var t = e.start,
						...
						n = e.name;
					if (
						(this.inGenerator && n === 'yield' && this.raiseRecoverable(t, "Cannot use 'yield' as identifier inside a generator"),
						this.inAsync && n === 'await' && this.raiseRecoverable(t, "Cannot use 'await' as identifier inside an async function"),
						...
						s.test(n) &&
							(!this.inAsync && n === 'await' && this.raiseRecoverable(t, "Cannot use keyword 'await' outside an async function"),
				...
				(Ie.declareName = function (e, t, r) {
					...
					if (t === _e) {
						...
						(this.treatFunctionsAsVar ? (n = u.lexical.indexOf(e) > -1) : (n = u.lexical.indexOf(e) > -1 || u.var.indexOf(e) > -1),
							u.functions.push(e));
					} else
						for (var h = this.scopeStack.length - 1; h >= 0; --h) {
							...
							if ((p.var.push(e), this.inModule && p.flags & Ye && delete this.undefinedExports[e], p.flags & kt)) break;
						}
				...
				(ye = function (e, t, r, n, s) {
					((this.token = e), (this.isExpr = !!t), (this.preserveSpace = !!r), (this.override = n), (this.generator = !!s));
				}),
				(ie = {
					b_stat: new ye('{', !1),
					b_expr: new ye('{', !0),
				...
				(f.parenR.updateContext = f.braceR.updateContext =
					function () {
						...
						(e === ie.b_stat && this.curContext().token === 'function' && (e = this.context.pop()), (this.exprAllowed = !e.isExpr));
					}),
				...
				(be.prototype.nextIndex = function (e, t) {
					...
					var s = r.charCodeAt(e),
						o;
					return !(t || this.switchU) || s <= 55295 || s >= 57344 || e + 1 >= n || (o = r.charCodeAt(e + 1)) < 56320 || o > 57343
						? e + 1
						: e + 2;
				}),
				...
				(q.regexp_eatBracedQuantifier = function (e, t) {
					...
					if (e.eat(123)) {
						...
						if (
							...
							((n = e.lastIntValue), e.eat(44) && this.regexp_eatDecimalDigits(e) && (s = e.lastIntValue), e.eat(125))
						)
				...
				(q.regexp_eatRegExpIdentifierName = function (e) {
					if (((e.lastStringValue = ''), this.regexp_eatRegExpIdentifierStart(e))) {
						for (e.lastStringValue += St(e.lastIntValue); this.regexp_eatRegExpIdentifierPart(e); ) e.lastStringValue += St(e.lastIntValue);
						return !0;
					}
					return !1;
				}),
				...
				(q.regexp_eatUnicodePropertyValue = function (e) {
					var t = 0;
					for (e.lastStringValue = ''; Yi((t = e.current())); ) ((e.lastStringValue += St(t)), e.advance());
					return e.lastStringValue !== '';
				}),
				...
				(q.regexp_eatDecimalDigits = function (e) {
					var t = e.pos,
						r = 0;
					for (e.lastIntValue = 0; Lt((r = e.current())); ) ((e.lastIntValue = 10 * e.lastIntValue + (r - 48)), e.advance());
					return e.pos !== t;
				}),
				(q.regexp_eatHexDigits = function (e) {
					var t = e.pos,
						r = 0;
					for (e.lastIntValue = 0; Gr((r = e.current())); ) ((e.lastIntValue = 16 * e.lastIntValue + Jr(r)), e.advance());
					return e.pos !== t;
				}),
				...
				(J.skipBlockComment = function () {
					...
					if ((r === -1 && this.raise(this.pos - 2, 'Unterminated comment'), (this.pos = r + 2), this.options.locations)) {
						ze.lastIndex = t;
						for (var n; (n = ze.exec(this.input)) && n.index < this.pos; ) (++this.curLine, (this.lineStart = n.index + n[0].length));
					}
				...
				(J.skipLineComment = function (e) {
					for (
						var t = this.pos, r = this.options.onComment && this.curPosition(), n = this.input.charCodeAt((this.pos += e));
				...
				(J.readToken_mult_modulo_exp = function (e) {
					...
					return (
						this.options.ecmaVersion >= 7 && e === 42 && t === 42 && (++r, (n = f.starstar), (t = this.input.charCodeAt(this.pos + 2))),
				...
				(J.readToken_lt_gt = function (e) {
					...
					return t === e
						? ((r = e === 62 && this.input.charCodeAt(this.pos + 2) === 62 ? 3 : 2),
							this.input.charCodeAt(this.pos + r) === 61 ? this.finishOp(f.assign, r + 1) : this.finishOp(f.bitShift, r))
						: t === 33 &&
							  e === 60 &&
							  !this.inModule &&
				...
				(J.readInt = function (e, t, r) {
					for (
						...
						if ((g >= 97 ? (F = g - 97 + 10) : g >= 65 ? (F = g - 65 + 10) : g >= 48 && g <= 57 ? (F = g - 48) : (F = 1 / 0), F >= e))
							break;
						((h = g), (u = u * e + F));
					}
					return (
						n && h === 95 && this.raiseRecoverable(this.pos - 1, 'Numeric separator is not allowed at the last of digits'),
				...
				(J.readString = function (e) {
					for (var t = '', r = ++this.pos; ; ) {
						...
						n === 92
							...
							: (Ze(n, this.options.ecmaVersion >= 10) && this.raise(this.start, 'Unterminated string constant'), ++this.pos);
					}
				...
				(J.readWord1 = function () {
					...
					for (var e = '', t = !0, r = this.pos, n = this.options.ecmaVersion >= 6; this.pos < this.input.length; ) {
						...
						if (qe(s, n)) this.pos += s <= 65535 ? 1 : 2;
							...
							((t ? Te : qe)(u, n) || this.invalidStringToken(o, 'Invalid Unicode escape'), (e += Ut(u)), (r = this.pos));
						} else break;
						t = !1;
					}
		...
		'../../node_modules/acorn-jsx/index.js'(e, t) {
			...
			((t.exports = function (m) {
				return (
					(m = m || {}),
					function (g) {
						return p({ allowNamespaces: m.allowNamespaces !== !1, allowNamespacedObjects: !!m.allowNamespacedObjects }, g);
					}
				);
			}),
					...
					jsx_readToken() {
						...
						for (;;) {
							...
							switch (B) {
								...
								default:
									L(B) ? ((y += this.input.slice(v, this.pos)), (y += this.jsx_readNewLine(!0)), (v = this.pos)) : ++this.pos;
							}
						}
					}
					jsx_readNewLine(y) {
...
`))
					...
					jsx_readString(y) {
						...
						for (;;) {
							...
							P === 38
								...
								: L(P)
									? ((v += this.input.slice(B, this.pos)), (v += this.jsx_readNewLine(!1)), (B = this.pos))
									: ++this.pos;
						}
					...
					jsx_parseIdentifier() {
						...
						return (
							this.type === D.jsxName ? (y.name = this.value) : this.type.keyword ? (y.name = this.type.keyword) : this.unexpected(),
							this.next(),
					...
					jsx_parseElementName() {
						...
						for (
							this.type === C.dot && B.type === 'JSXNamespacedName' && !m.allowNamespacedObjects && this.unexpected();
							this.eat(C.dot);
						) {
					...
					jsx_parseExpressionContainer() {
						...
						return (
							this.next(),
							(y.expression = this.type === C.braceR ? this.jsx_parseEmptyExpression() : this.parseExpression()),
					...
					jsx_parseOpeningElementAt(y, v) {
						...
						for (P && (B.name = P); this.type !== C.slash && this.type !== D.jsxTagEnd; ) B.attributes.push(this.jsx_parseAttribute());
						return (
					...
					jsx_parseClosingElementAt(y, v) {
						...
						return (P && (B.name = P), this.expect(D.jsxTagEnd), this.finishNode(B, P ? 'JSXClosingElement' : 'JSXClosingFragment'));
					}
					...
					updateContext(y) {
						if (this.type == C.braceL) {
							...
							(v == w ? this.context.push(E.b_expr) : v == S ? this.context.push(E.b_tmpl) : super.updateContext(y),
								(this.exprAllowed = !0));
			...
			var t =
				...
				r =
					...
					function () {
						...
						for (var F = Array(p), A = 0, m = 0; m < g; m++) for (var C = arguments[m], D = 0, E = C.length; D < E; D++, A++) F[A] = C[D];
						return F;
					};
...
`
					...
					A.singleQuotes ? ((p = p.replace(/\\?'/g, "\\'")), "'" + p + "'") : ((p = p.replace(/"/g, '\\"')), '"' + p + '"')
				);
			}
			e.prettyPrint = h;
		},
	...
	var s = n.reduce(function (h, p) {
		...
		return m
			? h.concat(
					m.map(function (g) {
						var F, A;
						return (A = (F = g.match(/[\t ]/g)) === null || F === void 0 ? void 0 : F.length) !== null && A !== void 0 ? A : 0;
					}),
				)
			: h;
	}, []);
...
N.ImportSpecifier = N.ImportDefaultSpecifier = N.ImportNamespaceSpecifier = N.Identifier = N.Literal = Je;
...
function Ps(e) {
	...
	return cn(e) === !1
		? !1
		: ((t = e.constructor), t === void 0 ? !0 : ((r = t.prototype), !(cn(r) === !1 || r.hasOwnProperty('isPrototypeOf') === !1)));
}
var Ns = nt(ns()),
	Be = nt(ss()),
	Pe = function (e, t) {
		...
		: (t.add(e),
			Array.isArray(e)
				...
				: Object.keys(e)
						.sort()
						.reduce(function (r, n) {
							return (n === '_owner' || (n === 'current' || t.has(e[n]) ? (r[n] = '[Circular]') : (r[n] = Er(e[n], t))), r);
						}, {}));
}
function Vs(e) {
...
var Wn = function (e) {
	...
	wr = function e(t, r) {
		...
		if (!ft.isValidElement(t)) throw new Error('react-element-to-jsx-string: Expected a React.Element, got `'.concat(gt(t), '`'));
		var o = s(t),
			u = pn(t.props, hn);
	...
	yu = (e, t) => {
		...
		if (ln(e.render)) r = !0;
			...
			try {
				...
				(u ? h.length === 1 && h[0].type === 'ObjectPattern' && (o = e({})) : (o = e()), o != null && Qn(o) && (r = !0));
			} catch {}
		}
		let s = Yn(e, t.name);
		if (s != null) {
...
`,
	...
	ti = (e, t) => {
		...
		let u = { ...Zu, ...((t == null ? void 0 : t.parameters.jsx) || {}) },
			h =
				(F = (g = t == null ? void 0 : t.parameters.docs) == null ? void 0 : g.source) != null && F.excludeDecorators
