	...
	(() => {
		...
		var U = { type: 'item', value: '' },
			K = (r, t) => ({
				...
				toolbar: {
					...
					items: t.toolbar.items.map((e) => {
						...
						return (o.type === 'reset' && t.toolbar.icon && ((o.icon = t.toolbar.icon), (o.hideIcon = !0)), { ...U, ...o });
					}),
				},
			}),
			Y = ['reset'],
			...
			z = (r) => (t) => {
				...
				return (
					g(() => {
						a && q(c, e, { next: { ...a.next, action: f }, previous: { ...a.previous, action: I }, reset: { ...a.reset, action: C } });
					}, [c, e, a, f, I, C]),
					g(() => {
						l.current = $(o);
					}, []),
			...
			Q = ({ right: r, title: t, value: e, icon: o, hideIcon: a, onClick: c, disabled: _, currentValue: i }) => {
				let l = o && n.createElement(R, { style: { opacity: 1 }, icon: o, __suppressDeprecationWarning: !0 }),
					u = { id: e ?? '_reset', active: i === e, right: r, title: t, disabled: _, onClick: c };
				return (o && !a && (u.icon = l), u);
			},
			X = z(({ id: r, name: t, description: e, toolbar: { icon: o, items: a, title: c, preventDynamicIcon: _, dynamicTitle: i } }) => {
				let [l, u, C] = A(),
					[f, I] = B(!1),
					s = l[r],
					m = !!s,
				...
				return n.createElement(
					...
					n.createElement(J, { active: f || m, disabled: d, description: e || '', icon: p, title: b || '' }),
				);
			}),
			ee = () => {
				let r = M(),
		...
		k.register(S, () => k.add(S, { title: S, type: P.TOOL, match: ({ tabId: r }) => !r, render: () => n.createElement(ee, null) }));
	})();
} catch (e) {
