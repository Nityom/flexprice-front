	...
	(() => {
		...
		var ue = (e, o, c, r) => {
			if ((o && typeof o == 'object') || typeof o == 'function')
				for (let i of ae(o)) !le.call(e, i) && i !== c && W(e, i, { get: () => o[i], enumerable: !(r = ie(o, i)) || r.enumerable });
			return e;
		};
		var Ie = (e, o, c) => (
			(c = e != null ? re(ce(e)) : {}),
							...
							function (r, i, d) {
									...
									return function (S) {
										var m = function () {
											...
											return (
												...
												a > 0 && ((x[T] = { cacheItem: b, arg: arguments[T] }), O ? t(s, x) : s.push(x), s.length > a && n(s.shift())),
												(m.wasMemoized = O),
												(m.numArgs = T + 1),
												R
											);
								...
								function n(a) {
									var I = a.length,
										...
										S,
										m;
									for (s.cacheItem.delete(s.arg), m = I - 2; m >= 0 && ((s = a[m]), (S = s.cacheItem.get(s.arg)), !S || !S.size); m--)
