	...
	(() => {
		...
		var ye = (e, t, a, s) => {
			if ((t && typeof t == 'object') || typeof t == 'function')
				for (let c of fe(t)) !we.call(e, c) && c !== a && J(e, c, { get: () => t[c], enumerable: !(s = he(t, c)) || s.enumerable });
			return e;
		};
		var Se = (e, t, a) => (
			(a = e != null ? me(ge(e)) : {}),
									...
									return function (u) {
										var I = function () {
											...
											return (
												...
												n > 0 && ((M[S] = { cacheItem: h, arg: arguments[S] }), A ? o(r, M) : r.push(M), r.length > n && i(r.shift())),
												(I.wasMemoized = A),
												(I.numArgs = S + 1),
												k
											);
						...
						: l.createElement(
								...
								l.createElement(
									...
									l.createElement(
										...
										l.createElement(j, null),
										r ? l.createElement(He, null, e.viewportRotated ? `${n.title} (L)` : `${n.title} (P)`) : null,
									),
								),
								r
									? l.createElement(
